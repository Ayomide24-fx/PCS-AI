...
// Latest MT5 quotes are stored in memory.
// The MT5 connector will push quotes here.
...
function saveMarketQuote(quote) {
    ...
    MARKET_QUOTES.set(
        `${symbol}:${timeframe}`,
        {
            ...
            bid:
                isValidNumber(quote.bid)
                    ? Number(quote.bid)
                    : null,

            ask:
                isValidNumber(quote.ask)
                    ? Number(quote.ask)
                    : null,

            spread:
                isValidNumber(quote.spread)
                    ? Number(quote.spread)
                    : null,

            change:
                isValidNumber(quote.change)
                    ? Number(quote.change)
                    : null,
...
app.post(
    ...
    (req, res) => {
        ...
        return res.json({
            ...
            bid:
                isValidNumber(body.bid)
                    ? Number(body.bid)
                    : null,

            ask:
                isValidNumber(body.ask)
                    ? Number(body.ask)
                    : null,

            spread:
                isValidNumber(body.spread)
                    ? Number(body.spread)
                    : null,
...
app.post(
    ...
    (req, res) => {
        ...
        // Public dashboard can NEVER enable
        // live trading.
